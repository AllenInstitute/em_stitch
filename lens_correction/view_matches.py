...
ddir = '/allen/programs/celltypes/workgroups/em-connectomics/danielk/lcdata/lens_correction13/000000/0'
...
pim, qim, p, q, pname, qname = get_ims_and_coords(matches[ind], ddir)
